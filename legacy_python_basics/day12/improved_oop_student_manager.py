...
class StudentManager:
	...
	def add_student(self):
		while True:
			try:
				self.n_1=int(input("Enter the number of the students :"))
				break
		...
		while True:
			try:
				self.n_2=int(input("Enter the number of subjects :"))
				break
		...
		for self.i in range(self.n_1):
			stu_marks={}
			stu_name=input("Name of the student :")
			for self.j in range(self.n_2):
...
# Save data to a file
	...
	def save_data_to_file(self,filename="improved_oop_students_data.txt"):
...
# Load data from a file
	...
	def load_students_from_file(self,filename="improved_oop_students_data.txt"):
		try:
